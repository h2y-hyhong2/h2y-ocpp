...
#### 1.4.1. [제 1안: Spring Integration 버전 - 권장] EIP[^EIP](Enterprise Integration Patterns, 엔터프라이즈 통합 패턴) 기반 분산 진화형 아키텍처
...
* **단점:** 구조적 추상화 수준이 높아 초반 진입 장벽 및 설정 공수가 다소 필요함.기능 정의서 상의 Phase 1 필수 기능(OCPP 1.6J 연동, 일반 관제 대시보드, 정산 원장 저장 및 단독 튜닝)의 100% 완료 및 안정화 검증 | **24주차 말 (6개월차)** |
...
| **운영 모니터링 가시성** | ★★★★★ | ★★★★☆ | Kafka 모니터링은 공통 적용되나 SI 버전의 Channel Interceptor를 통한 가시성 확보이 추가됨. |
