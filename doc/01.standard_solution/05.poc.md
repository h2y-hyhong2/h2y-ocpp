...
```mermaid
gantt
    title Phase 1 기술 검증(POC) 6개월 수행 일정 (일요일 시작 기준)
    dateFormat  YYYY-MM-DD
    axisFormat  %Y-%m-%d

    section 1개월차
    요건 분석 및 기능 정의 :active, poc_analysis, 2026-07-05, 28d
...
### 1.1. 주차별 세부 마일스톤 및 수행 작업 (Weekly Detailed Milestones & Date Ranges)

#### 1개월차: 요건 분석 및 기능 정의 (Month 1: 2026.07.05 ~ 2026.08.01)

- **1주차 (Week 1 / 2026.07.05일 ~ 2026.07.11토):**
...
#### 2개월차: 시스템 아키텍처 및 상세 설계 (Month 2: 2026.08.02 ~ 2026.08.29)
...
#### 3개월차: 개발 환경 구축 및 WebSocket Gateway 개발 (Month 3: 2026.08.30 ~ 2026.09.26)
...
#### 4개월차: 백엔드 비즈니스 로직 및 프론트 기본 개발 (Month 4: 2026.09.27 ~ 2026.10.24)
...
#### 5개월차: 정산 엔진 및 장애 관리, UI 통합 개발 (Month 5: 2026.10.25 ~ 2026.11.21)
...
- **19주차 (Week 19 / 2026.11.08일 ~ 2026.11.14토):**
  ...
  - **[원격 제어]** 어드민 API 원격 제어 명령(`Reset`, `UnlockConnector`) 수신 시 active WebSocket 세션으로 OCPP Call 패킷 즉시 라우팅 처리.
...
#### 6개월차: 리소스 최적화, 통합 검증 및 배포 패키징 (Month 6: 2026.11.22 ~ 2026.12.19)
