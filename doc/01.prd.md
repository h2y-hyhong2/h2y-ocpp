...
| **예상 도입 비용 (전체 합산)** | **On-Premise:** 약 20,000,000 KRW (1회성)<br>**Cloud (AWS):** 월 약 $1,450 (약 1,900,000원) | **On-Premise:** 약 35,000,000 KRW (1회성)<br>**Cloud (AWS):** 월 약 $2,630 (약 3,500,000원) | 전체 클러스터 인프라 구성 비용 (On-Premise는 L4/L7 스위칭 허브 및 NAS 백업 장비 포함). |
