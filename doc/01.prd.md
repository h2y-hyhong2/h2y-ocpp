...
| **예상 도입 비용** | **On-Premise:** 약 4,000,000 KRW (1회성)<br>**Cloud (AWS):** 월 약 $280 (약 370,000원) | **On-Premise:** 약 6,000,000 KRW (1회성)<br>**Cloud (AWS):** 월 약 $560 (약 740,000원) | 물리 장비 일시불 구매(워크스테이션/엔트리 서버, 부가세 별도) 또는 AWS 클라우드 월별 임대료 환산. |
